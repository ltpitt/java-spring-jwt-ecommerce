package it.davidenastri.ecommerce.security;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest req,
        ...
        try {
            it.davidenastri.ecommerce.model.persistence.User credentials = new ObjectMapper()
                    .readValue(req.getInputStream(), it.davidenastri.ecommerce.model.persistence.User.class);
